...
def main():
    ...
    # Nombre del archivo
    filename = "PKG - COMPONENTES CON HEAT STAKES - UAEMEX/PKG - COMPONENTES CON HEAT STAKES - UAEMEX/EXERCISE 5 -DOOR PANELS.stp"
    #filename = "PKG - COMPONENTES CON HEAT STAKES - UAEMEX/PKG - COMPONENTES CON HEAT STAKES - UAEMEX/PMI - EXERCISE 1 - DOOR PANELS.stp"
